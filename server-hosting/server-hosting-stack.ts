...
export class ServerHostingStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    if (Config.restartApi && Config.restartApi === true) {
      ...
      const authFunction = new lambda_nodejs.NodejsFunction(
        this,
        `${Config.prefix}AuthFunctionLambda`,
        {
          entry: "./server-hosting/lambda/authorizer.ts",
      ...
      const authorizer = new apigw.RequestAuthorizer(
        this,
        `${Config.prefix}BasicAuthAuthorizer`,
        {
